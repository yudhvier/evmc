...
public:
    ...
    {
        auto* h = reinterpret_cast<Host*>(context);  // Get pointer of the Host base class.
        return static_cast<DerivedClass*>(h);  // Additinal downcast, only possible if DerivedClass
                                               // inherits from Host.
    }
};
